// Path: components/CategoriesPageClient.tsx
                  ...
                  <div key={product.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group relative">
                    ...
                    <div className="px-3 sm:px-4 pb-3 sm:pb-4 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200">
                      <button
                        ...
                        disabled={stock === 0}
                        className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                      >
